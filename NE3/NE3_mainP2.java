...
public class NE3_mainP2 {
	public static void main(String[] args) {
        ...
        double findgoodalternativecount = 0;
            ...
            for (int i = 0; i < k; i++ ){
                ...
                for (int j = 0; j < d; j++){
                    if (spberp.get(i).get(j) < 1 - gammas.get(j) - izsp.get(j)){
                        goodAltOrNot = false;
//                        System.out.println(i+" 因为第 "+j+" 个次目标 "+spberp.get(i).get(j)+" 小于 "+(1 - gammas.get(j) - izsp.get(j)));
                    }
                }
                if (ppmu.get(0) > ppmu.get(i)+izpp){
                    goodAltOrNot = false;
//                    System.out.println(i+" 因为主目标 "+ppmu.get(i)+" 小于 "+(ppmu.get(0)-izpp));
                }
                if (goodAltOrNot){
                    numGoodAlt+=1;
//                    System.out.println(i+"是goodalternative 因为 "+ppmu.get(i)+"  "+spberp.get(i).get(0));
                }
            }
...
//        findgoodalternativecount = repeat - cantFindG;
...
//        System.out.println("FG "+FG+" "+FG/repeat);
//        System.out.println("IFG "+IFG+" "+IFG/repeat);
//        System.out.println("FNG "+FNG+" "+FNG/repeat);
//        System.out.println("IFNG "+IFNG+" "+IFNG/repeat);
//        System.out.println("cantFindG "+cantFindG+" "+cantFindG/repeat);
