...
public class NE1_mainCCSBIZ {
	public static void main(String[] args) {
        ...
        double izsp = 2*deltay;

//        double izpp = 0.5*deltax;
//        double izsp = 0.5*deltay;

        ArrayList<Double> ssinterval= new ArrayList<>();

//        CCSP1 y1 = new CCSP1();
        System.out.println(k+" "+izpp+" "+izsp+" b-1 "+(b-1));
...
//                    System.out.println(1-gamma-0.4/250*(i-b+1));
            ...
            NE1_CCSBIZ y1 = new NE1_CCSBIZ(alpha, izpp, izsp, gamma, feasibleThreshold, ppmu, ppsigma2, spberp, tempSeed);
            y1.run();
...
//            }
        ...
        System.out.println(k+" "+izpp+" "+izsp);
