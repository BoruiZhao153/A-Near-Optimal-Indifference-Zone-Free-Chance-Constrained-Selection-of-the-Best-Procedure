...
//                    System.out.println(1-gamma+0.1/(b-1)*(i));
                }else {
                    ppmu.add(R.nextDouble()*5*deltax);
                    spberp.add(1-gamma-0.4/(b-1)*(i-b+1));
//                    System.out.println(1-gamma-0.4/(b-1)*(i-b+1));
                }
                ppsigma2.add(100.0);
            }

            long tempSeed = R.nextLong();
            NE1_P2 y1 = new NE1_P2(alpha, gamma, feasibleThreshold, ppmu, ppsigma2, spberp, tempSeed);
            y1.run();
